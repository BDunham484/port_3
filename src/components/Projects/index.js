    ...
    return (
        ...
        <section id="projects">
            ...
            <div class="project-wrapper">
                <div>
                    <p class="wrapped-titles">
                        TODAY'S TECH
                    </p>
                    <a href="https://powerful-journey-30948.herokuapp.com/"><img class="wrapped-img"
                ...
                <div>
                    ...
                    <a href="https://bdunham484.github.io/weather-request-permitting/"><img class="wrapped-img"
                ...
                <div>
                    ...
                    <a href="https://bdunham484.github.io/project1/"><img class="wrapped-img"
                ...
                <div>
                    ...
                    <a href="https://www.orbit-watches.com"><img class="wrapped-img"
                ...
                <div class="project-description">
                    <div class="project-text-container">
                        <div class="project-text">I develop Fitbit clock faces and sell them in their app store. The clock
                            faces
